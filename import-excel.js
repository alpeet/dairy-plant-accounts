...
function importSales(db, sheetData, partyNameToId, productNameToId) {
    ...
    // NOTE: Ledger entries are not created here to avoid duplication.
    // The Party_Ledger import (importPartyLedger) handles all ledger entries.
...
function importPartyLedger(db, sheetData, partyNameToId) {
    ...
    trx();
    console.log(`  ✅ ${count} ledger entries imported`);
